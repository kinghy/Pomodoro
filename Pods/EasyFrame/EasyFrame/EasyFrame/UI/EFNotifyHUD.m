...
- (void)setCurrentOpacity:(CGFloat)currentOpacity {
    ...
    self.backgroundView.backgroundColor = [self.backgroundColor colorWithAlphaComponent:currentOpacity];
...
- (UIView *)backgroundView {
    ...
    _backgroundView.backgroundColor = [self.backgroundColor colorWithAlphaComponent:0.0f];
